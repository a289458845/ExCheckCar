...
Pod::Spec.new do |s|
  s.name             = 'ExCheckCar'
  s.version          = '0.1.0'
  s.summary          = 'A short description of ExCheckCar.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Peng/ExCheckCar'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Peng' => '289458845@qq.com' }
  s.source           = { :git => 'https://github.com/Peng/ExCheckCar.git', :tag => s.version.to_s }
